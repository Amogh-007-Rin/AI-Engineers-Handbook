...
Reference runtime: CPython 3.12 on CPU. The `onnx` authoring wheel is not part
of this project's Python 3.14 compatibility contract; use the CI runtime rather
than an unsupported source build.
